...
-- -----------------------------------------------------
-- Table SalesOrderHeaderBranchs
-- -----------------------------------------------------
CREATE TABLE Sales.SalesOrderHeaderBranchs (
  SalesOrderHeaderBranchsKey INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
  SalesOrderNumber VARCHAR(15) UNIQUE NOT NULL,
  OrderDate DATE NOT NULL,
  DueDate DATE NOT NULL,
  ShipDate DATE NOT NULL,
...
-- -----------------------------------------------------
-- Table SalesOrderDetailBranchs
-- -----------------------------------------------------
CREATE TABLE Sales.SalesOrderDetailBranchs (
  SalesOrderDetailBranchsKey INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
  OrderQuantity INT NULL,
  UnitPrice MONEY NOT NULL,
  ProductKey INT NOT NULL,
  SalesOrderLineNumber TINYINT NOT NULL,
  SalesOrderHeaderBranchsKey INT NOT NULL,
  BranchName VARCHAR(15),
  FOREIGN KEY (ProductKey) REFERENCES Products.Product (ProductKey),
  FOREIGN KEY (SalesOrderHeaderBranchsKey) REFERENCES Sales.SalesOrderHeaderBranchs (SalesOrderHeaderBranchsKey)
);
