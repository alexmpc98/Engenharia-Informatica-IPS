 ...
 * @param listPatients Lista que recebe os valores lidos do ficheiro
 */
 ...
 * 
 * @param filename Nome do ficheiro (com extensão)
 * @param listRegions Lista que recebe os valores lidos do ficheiro
 */
void importRegionsFromFile(char *filename, PtMap *mapRegions){
    ...
    *mapRegions = mapCreate(4);
    ...
    // Este bloco de código necessita ser passado para um método que retorne a string
    char population[100];
