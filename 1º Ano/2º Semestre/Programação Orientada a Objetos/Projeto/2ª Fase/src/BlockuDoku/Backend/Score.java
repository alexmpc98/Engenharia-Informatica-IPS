...
public class Score implements Serializable {
    ...
    /**
     * Este método retorna a data e a pontuação em string.
     *
     * @return Data e pontuação (String)
     */
    public String toString() {    
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm:ss");
        return "Data e hora: " + this.dateTime.format(formatter) + " | Pontuação: " + this.points + "\n";
    }
}
